      ...
      <div className="glass p-5">
        <div className="mb-4 inline-flex rounded-xl border border-border bg-surface/50 p-1 text-xs font-semibold">
          <button
            ...
            className={`inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 transition-all duration-200 ${mode === "file" ? "bg-surface-2 text-foreground shadow-[var(--glow-blue)]" : "text-muted-foreground hover:text-foreground"}`}
          >
          ...
          <button
            ...
            className={`inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 transition-all duration-200 ${mode === "paste" ? "bg-surface-2 text-foreground shadow-[var(--glow-blue)]" : "text-muted-foreground hover:text-foreground"}`}
          >
        ...
        {mode === "file" ? (
          <label className="flex cursor-pointer flex-col items-center gap-2 rounded-xl border border-dashed border-border bg-surface/40 p-10 text-center transition-colors duration-200 hover:border-[color:var(--neon-blue)]">
          ...
          <div className="space-y-3">
            <textarea
              ...
              className="w-full resize-y rounded-xl border border-border bg-surface/40 p-4 font-mono text-xs leading-relaxed text-foreground outline-none transition-colors duration-200 placeholder:text-muted-foreground/60 focus:border-[color:var(--neon-blue)]"
            />
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  onClick={runText}
                  disabled={busy}
                  className="inline-flex items-center gap-2 rounded-xl bg-[image:var(--gradient-neon)] px-5 py-2 text-xs font-semibold text-[color:var(--primary-foreground)] transition-opacity duration-200 hover:opacity-90 disabled:opacity-50"
                >
