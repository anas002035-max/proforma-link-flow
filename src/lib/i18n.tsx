...
const en: Dict = {
  ...
  "tools.lockedTitle": "This tool is part of DevMatrix Pro",
...
const overrides: Record<Exclude<LangCode, "en">, Dict> = {
  es: {
    ...
    "tools.locked": "Solo Pro", "tools.upgrade": "Mejorar a Pro", "tools.lockedTitle": "Esta herramienta es parte de DevMatrix Pro",
  ...
  fr: {
    ...
    "tools.locked": "Pro uniquement", "tools.upgrade": "Passer à Pro", "tools.lockedTitle": "Cet outil fait partie de DevMatrix Pro",
  ...
  de: {
    ...
    "tools.locked": "Nur Pro", "tools.upgrade": "Auf Pro upgraden", "tools.lockedTitle": "Dieses Werkzeug gehört zu DevMatrix Pro",
  ...
  it: {
    ...
    "tools.locked": "Solo Pro", "tools.upgrade": "Passa a Pro", "tools.lockedTitle": "Questo strumento fa parte di DevMatrix Pro",
  ...
  pt: {
    ...
    "tools.locked": "Apenas Pro", "tools.upgrade": "Mudar para Pro", "tools.lockedTitle": "Esta ferramenta faz parte do DevMatrix Pro",
  ...
  ja: {
    ...
    "tools.locked": "Pro限定", "tools.upgrade": "Proにアップグレード", "tools.lockedTitle": "このツールはDevMatrix Proの機能です",
  ...
  zh: {
    ...
    "tools.locked": "仅限专业版", "tools.upgrade": "升级到专业版", "tools.lockedTitle": "该工具属于 DevMatrix Pro",
